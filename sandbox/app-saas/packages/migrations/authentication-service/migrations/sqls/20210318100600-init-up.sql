...
CREATE TRIGGER mdt_auth_clients
    BEFORE UPDATE ON main.auth_clients
    FOR EACH ROW
    EXECUTE PROCEDURE main.moddatetime('modified_on');
...
CREATE TRIGGER mdt_user_credentials
    BEFORE UPDATE ON main.user_credentials
    FOR EACH ROW
    EXECUTE PROCEDURE main.moddatetime('modified_on');

CREATE TRIGGER mdt_user_permissions
    BEFORE UPDATE ON main.user_permissions
    FOR EACH ROW
    EXECUTE PROCEDURE main.moddatetime('modified_on');

CREATE TRIGGER mdt_user_tenants
    BEFORE UPDATE ON main.user_tenants
    FOR EACH ROW
    EXECUTE PROCEDURE main.moddatetime('modified_on');
...
ALTER TABLE main.tenant_configs
    ADD CONSTRAINT fk_tenant_configs_tenants FOREIGN KEY (tenant_id) REFERENCES main.tenants(id);

ALTER TABLE main.user_credentials
    ADD CONSTRAINT fk_user_credentials_users FOREIGN KEY (user_id) REFERENCES main.users(id);

ALTER TABLE main.user_permissions
    ADD CONSTRAINT fk_user_permissions FOREIGN KEY (user_tenant_id) REFERENCES main.user_tenants(id);

ALTER TABLE main.user_resources
    ADD CONSTRAINT fk_user_resources FOREIGN KEY (user_tenant_id) REFERENCES main.user_tenants(id);

ALTER TABLE main.user_tenants
    ADD CONSTRAINT fk_user_tenants_users FOREIGN KEY (user_id) REFERENCES main.users(id);

ALTER TABLE main.user_tenants
    ADD CONSTRAINT fk_user_tenants_tenants FOREIGN KEY (tenant_id) REFERENCES main.tenants(id);

ALTER TABLE main.user_tenants
    ADD CONSTRAINT fk_user_tenants_roles FOREIGN KEY (role_id) REFERENCES main.roles(id);
